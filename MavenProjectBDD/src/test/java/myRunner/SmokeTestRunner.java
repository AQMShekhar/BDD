...
@CucumberOptions(
        features = ("D:\\Users\\Temp\\git\\TestGit\\MavenProjectBDD\\src\\main\\resources\\features\\Login.feature"),
        glue = {"stepdefination"},
        tags = {"@Smoke"},
       plugin = {"pretty","html:target/cucumber-reports/report1.html", 
    		   "json:target/cucumber-reports/report1.json",
    		   "com.cucumber.listener.ExtentCucumberFormatter:target/cucumber-reports/ExtentreportSmoke.html"
        		},
       monochrome = true
		)
